...
export const assets: AssetDef[] = [
  ...
  { id: "camera", kind: "camera", label: "Caméra", group: "Caméras", layer: "cameras", color: "#e6c27f", defaults: { sensor: "ff", focal: 35, height: 1.5, support: "trepied" } },
...
export const lightTypes: LightDef[] = [
  ...
  { id: "softbox", label: "Softbox", beam: 90, reach: 3 },
